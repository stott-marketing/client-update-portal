            ...
            <article class="card client-card portfolio-card" data-punch-child="modern-auto-body">
              <div class="client-titleline">
                <div>
                  ...
                  <p>New Punch Club child account added for reporting setup.</p>
                </div>
                <span class="tag warning">Setup</span>
              </div>
              <div class="client-update">
                <p class="section-label">Digital Marketing Update</p>
                <p>Modern Auto Body has been added to the Punch Club client portfolio so reporting notes can be organized under the correct child account. The next step is to connect the available source systems, confirm which channels are active, and define the metrics that should appear in this portfolio view.</p>
              </div>
              <div class="performance-line"><strong>Modern Auto Body is ready for reporting setup once source access, active channels, and launch priorities are confirmed.</strong></div>
              <div class="metric-group">
                <h4>Performance Metrics</h4>
                <div class="metrics" aria-label="Modern Auto Body performance metrics">
                  <div class="metric"><span>Status</span><strong>Added</strong><div class="muted-change">Portfolio setup</div></div>
                  <div class="metric"><span>GA4</span><strong>Pending</strong><div class="muted-change">Property needed</div></div>
                  <div class="metric"><span>Ads</span><strong>Pending</strong><div class="muted-change">Account mapping</div></div>
                  <div class="metric"><span>Leads/actions</span><strong>Pending</strong><div class="muted-change">Define events</div></div>
                </div>
              </div>
            </article>
          </div>
