  ...
  <body>
    <div class="app">
      ...
      <main>
        ...
        <section class="card">
          <h2>Conversion Tracking and Lead Visibility</h2>
          ...
          <div class="grid-3">
            ...
            <article class="panel seo">
              <h3>Phone attribution remains separate</h3>
              <p>The website displays a direct phone number, but call tracking is not currently active. Phone inquiries may be occurring without being attributed back to the website, organic search, paid search, or specific landing pages.</p>
            </article>
          </div>
