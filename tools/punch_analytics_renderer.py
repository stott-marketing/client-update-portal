...
def apply_analytics(content):
    ...
    notes = {
        ...
        'phil-medeiros': 'Review the traffic decline and acquisition sources. Previous notes recorded 21 pages submitted for indexing; completion of subsequent indexing work has not been reconfirmed.',
