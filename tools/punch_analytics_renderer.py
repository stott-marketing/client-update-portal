...
def apply_analytics(content):
    ...
    highlights = (
        ...
        '<div class="executive-highlight"><strong>Organic growth is breaking through</strong><p>Phil Medeiros reached an average page-one position as clicks increased 125% and impressions increased 1,624%. Punch Transfers grew page-level impressions 82%, established a page-one content asset and moved its core DTF product page forward 14 positions. South Coast Towing and Tony’s Auto also improved their average search positions.</p></div>'
        '<div class="executive-highlight"><strong>Demand is being created efficiently</strong><p>Grub Tub generated 50,835 Meta impressions, 3,577 clicks and 1,868 landing-page views at an $0.08 CPC. Modern Auto Body produced five Instant Form leads at $25.98 each. Kathy Mackenzie recorded 764 campaign clicks at a 3.85% CTR, while LC Mechanical increased GA4 key events 60%.</p></div>'
        '<div class="executive-highlight"><strong>Implementation is strengthening performance</strong><p>Chem Nut Supply increased sessions 26.2% and active users 24.9%. South Coast Towing increased sessions 8.3% and active users 14.4%. Tony’s Auto raised engagement from 42.0% to 55.3%, and Punch Creatives improved sessions, users, engagement and organic clicks. These gains are supported by broader analytics coverage and cleaner client reporting.</p></div>'
        '</div>'
    ) if manual_matches else ''
    priority = '<p class="executive-priority"><strong>Next strategic priority:</strong> Turn the reach we have created into more verified business outcomes. That means completing conversion tracking for calls, forms, store clicks and purchases; advancing high-opportunity pages into top search positions; and following every lead through to an estimate, booking or sale. The portfolio has momentum. Our next standard is clearer attribution and stronger conversion from that demand.</p>' if manual_matches else ''
